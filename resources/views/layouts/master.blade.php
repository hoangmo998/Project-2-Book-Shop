            ...
            <div class="col-md-4">
                <form action="{{route('all-books')}}">
                    <div class="input-group input-group-sm m-1">
                        <input type="text" name="term" value="{{request('term')}}" class="form-control" placeholder="Tìm kiếm...">
...
<footer class="py-3 text-center border-top bg-light">
    <div class="container">
        ...
        <span class="mr-2">
          <a href="https://www.facebook.com/phuonghoa.nguyen.9028" class="text-primary"><i class="fab fa-facebook fa-2x"></i></a>
        </span>
            <span class="mr-2">
          <a href="https://github.com/min-cc/mincc1301" class="text-secondary"><i class="fab fa-github fa-2x"></i></a>
        </span>
        </div>
    </div>
</footer>
