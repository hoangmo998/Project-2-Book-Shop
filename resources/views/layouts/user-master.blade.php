    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item px-2">
                    <a href="{{route('discount-books')}}" class="nav-link">Giảm giá</a>
                </li>
            </ul>
...
<footer class="py-3 text-center border-top bg-light">
    <div class="container">
        ...
        <div class="social-icon mt-2">
                <span class="mr-2">
                    <a href="https://www.facebook.com/phuonghoa.nguyen.9028" class="text-primary"><i
                            class="fab fa-facebook fa-2x"></i></a>
                </span>
            <span class="mr-2">
                    <a href="https://github.com/min-cc/mincc1301" class="text-secondary"><i
